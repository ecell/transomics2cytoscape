...
##' @param pathwayList a list with KEGG pathwayID and the Zheight in 3Dspace
...
create3Dcyjs <- function(pathwayList, kinase2enzyme, stylexml, outputcyjs) {
    checkCyApps()
    ...
    suID <- RCy3::createNetworkFromDataFrames(nodes, unique(edges))
